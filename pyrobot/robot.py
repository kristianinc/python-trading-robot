...
class PyRobot():
    ...
    def regular_market_open(self)->bool:
        ...
        market_end_time = datetime.now().replace(hour=13,minute=30, second=00, tzinfo=timezone.utc).timestamp()
        right_now = datetime.now().replace(tzinfo=timezone.utc).timestamp()
    ...
    def grab_historical_prices(self)->dict:
        pass
